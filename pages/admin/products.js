...
function AdminProdcuts() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        const { data } = await axios.get(`${process.env.NEXT_PUBLIC_RESTAPI_URL}products/`, {
          headers: {
  ...
  const createHandler = async () => {
    ...
    try {
      ...
      const { data } = await axios.post(
        `${process.env.NEXT_PUBLIC_RESTAPI_URL}products/`,
        {},
        {
          headers: {
            "access-token": userToken["access-token"],
  ...
  const deleteHandler = async (productId) => {
    ...
    try {
      ...
      await axios.delete(`${process.env.NEXT_PUBLIC_RESTAPI_URL}products/${productId}`, {
        headers: {
          "access-token": userToken["access-token"],
           uid: userInfo.uid,
           client: userToken.client,
